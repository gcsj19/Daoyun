                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="change_user_handle.php" method="post" class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" value="<?php echo $user_name?>" placeholder="用户名" />
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="phone">电话</label>
                                        <input type="text" class="form-control" id="phone" name="phone" value="<?php echo $user_id?>" placeholder="电话" readonly="readonly"/>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="mail">邮箱</label>
                                        <input type="text" class="form-control" id="mail" name="mail" value="<?php echo $user_mail?>" placeholder="邮箱" />
                                    </div>
