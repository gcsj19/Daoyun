                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="change_course_handle.php?course_id=<?php echo $course_id ?>" method="post" class="row">
                                    <div class="form-group col-md-12">
                                        <label for="admin">负责人</label>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="course_name" name="course_name" value="<?php echo $course_name?>" placeholder="课程名" />
                                    </div>
