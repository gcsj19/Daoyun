<template>
	<view class="content">
						...
						<view >
							...
							<view class="desc-pad" v-if="isAm">
								<view class="time uni-timeline-item-content-t">
									签到时间 {{(amSign.time).substring(10,16)}}					
								</view>								
		...
		<uni-popup :show="type === 'middle-list'" position="middle" mode="fixed" @hidePopup="togglePopup('')">
			<view class="title" style="padding: 20upx 0;font-weight: bold;width: 100%;text-align: center;border-bottom: 1px solid #666;">签到备注</view>
			<view class="content" style="padding: 20upx 10upx;width: 100%;">
				<text class="text">签到时间:</text>
				<text>{{bzText.time}}</text>
				<view class="text">签到地点:</view>
